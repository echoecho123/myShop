...
<#assign imageList=goodsDesc.itemImages?eval/> <#--图片列表-->
<#assign customAttributeitems=goodsDesc.customAttributeItems?eval/><#--扩展属性-->
<#assign specificationItems=goodsDesc.specificationItems?eval/><#--规格列表-->
